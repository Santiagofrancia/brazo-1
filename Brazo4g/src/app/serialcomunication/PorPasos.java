...
public class PorPasos extends javax.swing.JFrame {
    ...
    public void letras() {
        ...
        if (caracteres <= 0) { //Si la cantidad de caracteres se ha agotado... 
            ...
            cadena = cadena.substring(0, 2); //Se evita que por alguna razón la variable contenga
            ...
            jLabelCaracteres.setText("Disponibles" + (caracteres));
        }
    }
    ...
    private void initComponents() {
        ...
        jButtonEnviar.setText("Enviar a arduino");
    ...
    private void jTextFieldMensajeActionPerformed(java.awt.event.ActionEvent evt) {                                                  
       ...
       private void jButtonServor1ActionPerformed(java.awt.event.ActionEvent evt) {                                               
        try {
       arduino.sendData("3");
       }catch(Exception ex){
    ...
    private javax.swing.JButton jButtonServor1ActionPerformed;                                             
