//definicion de pins
const int motorPin1 = 7;    // 28BYJ48 In1
const int motorPin2 = 6;    // 28BYJ48 In2
...
void setOutput2(int step)
{
  ...
  digitalWrite(motorPin4, bitRead(stepsLookup[step], 0));
  digitalWrite(motorPin3, bitRead(stepsLookup[step], 1));
  digitalWrite(motorPin2, bitRead(stepsLookup[step], 2));
  digitalWrite(motorPin1, bitRead(stepsLookup[step], 3));
}
